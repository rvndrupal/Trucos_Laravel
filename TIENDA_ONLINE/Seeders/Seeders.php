    ...
    public function run()
    {
	    ...
	    factory(\App\Course::class, 50)
		    ...
		    ->each(function (\App\Course $c) {
		    	$c->goals()->saveMany(factory(\App\Goal::class, 2)->create()); //cada curso tiene metas
		    	$c->requirements()->saveMany(factory(\App\Requirement::class, 4)->create()); //cada curso tiene requerimientos
		    });
    }
}
